...
class Cf7_2_Post {
    ...
    */
    ...
    $this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'register_scripts',9,1 );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'register_styles',9,1 );
