...
$clipboard_code = sprintf(
	"add_action('cf7_2_post_save_submission','c2p_save_%1\$s',10,3);\nfunction c2p_save_%1\$s(\$form_key, \$form_data, \$form_files){\n  //\$form_key is the unique form key.\n  // \$form_data is the submitted form data.\n  //\$form_files are submitted files if any.\n}",
	$cf7_key_flat
);
?>
<h1><?php echo esc_html( __( 'Save submissions as ', 'post-my-contact-form-7' ) ); ?><span id="custom-post-title"><?php echo esc_html( __( 'filter', 'post-my-contact-form-7' ) ); ?></span></h1>
...
<div id="c2p-factory-post">
	...
	<p>
		...
		<span id="c2p-filter-clipboard" class="cf7-post-msg animate-color">
			<a class="code" data-clipboard-text="<?php echo esc_attr( $clipboard_code ); ?>" href="#">cf7_2_post_save_submission</a>
...
(function($){
	$(document).ready(function(){
		// new Clipboard();
		document.querySelector('#c2p-filter-clipboard a.code').addEventListener('click', async (e) => {
